...
class GameScene(Scene):
    def __init__(self):
        ...
        # Stats texts dikanan permainan ditampilkan saat permainan berlangsung
    ...
    def update(self):
        ...
        #jika player fuel lebih dari 0 dan mati
        ...
        # Check for powerup collisions(menabrak powerup)
        ...
        if self.player.has_started:
            # Check for boundary collision (batas tabrakan)
